...
import { Moon, BookOpen, Smartphone, Star, CheckCircle, StickyNote, Plus, X, ListChecks } from "lucide-react";
...
export default function EveningForm({
  ...
  return (
    ...
    >
      <h2 className={`text-2xl font-bold mb-8 flex items-center gap-2 ${isDark ? "text-white" : "text-slate-900"}`}>
      ...
      <div className="space-y-7 mb-10">
        ...
        <div>
          ...
          <input
            ...
            disabled={saving}
            className={`w-full px-4 py-3 rounded-xl border text-lg font-medium transition focus:ring-4 focus:ring-indigo-500/30 ${
              isDark
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="1. &#10;2. &#10;3. "
            disabled={saving}
            className={`w-full px-4 py-3 rounded-xl border resize-none transition focus:ring-4 focus:ring-indigo-500/30 ${
              isDark
                ? "bg-slate-700/70 border-slate-600 text-white placeholder-slate-400"
        ...
        {/* Gratitude Journal */}
        <div className={`p-5 rounded-xl border ${isDark ? "bg-slate-700/50 border-slate-600" : "bg-amber-50 border-amber-200"}`}>
          <h3 className={`font-bold text-lg mb-4 flex items-center gap-2 ${isDark ? "text-amber-400" : "text-amber-700"}`}>
          ...
          <div className="space-y-3">
            <input
              ...
              disabled={saving}
              className={`w-full px-4 py-2 rounded-lg border text-sm transition focus:ring-2 focus:ring-amber-500/50 ${
                isDark
      ...
      <div className={`border-t ${isDark ? "border-slate-700" : "border-slate-300"} pt-8`}>
                ...
                <div className="flex items-center gap-3">
                  {typeof value === "boolean" ? (
                    ...
                    <input
                      ...
                      className={`w-28 px-4 py-2 rounded-lg border text-center font-medium ${
                        isDark
        ...
        <div className="flex gap-3">
          <input
            type="text"
            placeholder="e.g., Journaled, Stretch, No Late Snack"
            value={newFieldName}
      ...
      <div className="mt-10 space-y-6">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className={`w-full py-4 rounded-2xl font-bold text-lg transition transform hover:scale-105 active:scale-95 ${
            saving
