    ...
    <div className={`min-h-screen p-3 sm:p-4 md:p-6 ${isDark ? "bg-slate-900" : "bg-slate-50"}`}>
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
          <div>
            <h1
              className={`text-xl sm:text-2xl md:text-3xl font-bold flex items-center gap-2 sm:gap-3 ${
          ...
          <button
            ...
            className={`flex items-center justify-center gap-2 px-4 py-2 sm:py-2.5 rounded-lg font-medium transition text-sm sm:text-base ${
              isDark
        ...
        {error && !loading && (
          <div
            className={`p-4 sm:p-6 rounded-xl border text-sm sm:text-base ${
              isDark
        ...
        {!loading && !error && cumulativePnL.length === 0 && (
          <div
            className={`text-center py-12 sm:py-20 rounded-xl border ${
