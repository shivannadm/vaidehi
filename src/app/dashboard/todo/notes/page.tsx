          ...
          <div className="space-y-3 sm:space-y-0 sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                className={`sm:hidden p-2 rounded-lg border ${isDark ? 'bg-slate-800 border-slate-700 text-slate-300' : 'bg-white border-slate-200 text-slate-600'
                  }`}
              >
              ...
              <div className="hidden sm:block relative">
                ...
                <input
                  ...
                  className={`pl-10 pr-4 py-2 rounded-lg border text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 ${isDark
              ...
              {/* View Toggle */}
              <div className={`flex items-center rounded-lg border ${isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'
                }`}>
                <button
              ...
              <button
                ...
                className={`px-2 sm:px-4 py-2 rounded-lg font-medium text-xs sm:text-sm transition flex items-center gap-2 ${showArchived
                    ? 'bg-indigo-600 text-white'
                    : isDark
          ...
          {showSearch && (
            <div className="sm:hidden relative animate-in slide-in-from-top-2">
              ...
              <input
                ...
                placeholder="Search notes..."
                autoFocus
                className={`w-full pl-10 pr-10 py-2 rounded-lg border text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 ${isDark
                    ? 'bg-slate-800 border-slate-700 text-white placeholder-slate-400'
                    : 'bg-white border-slate-200 text-slate-900 placeholder-slate-400'
                  }`}
              />
          ...
          {filteredNotes.length === 0 ? (
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              {pinnedNotes.length > 0 && (
                <div>
                  <h2 className={`text-xs font-semibold uppercase tracking-wide mb-2 sm:mb-3 ${isDark ? 'text-slate-400' : 'text-slate-600'
                    }`}>
                    📌 Pinned
                  </h2>
