    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="text-right">
          <div
            className={`text-2xl font-bold ${progress === 100
                ? "text-green-500"
                : isDark
                  ? "text-white"
                  : "text-slate-900"
      ...
      {/* Progress Bar */}
      <div
        className={`h-4 rounded-full overflow-hidden ${isDark ? "bg-slate-700" : "bg-slate-200"
          }`}
      >
        <div
      ...
      <div className="flex items-center justify-between mt-2 px-1">
        {[0, 25, 50, 75, 100].map((milestone) => (
          <div key={milestone} className="text-center">
            <div
              className={`w-2 h-2 rounded-full mb-1 ${progress >= milestone
                  ? "bg-green-500"
                  : isDark
                    ? "bg-slate-600"
                    : "bg-slate-300"
            ...
            />
            <span
              className={`text-xs ${progress >= milestone
