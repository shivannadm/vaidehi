...
export default function HighlightInput({
  ...
  return (
    <textarea
      ...
      rows={4}
      className={`w-full px-4 py-3 sm:px-5 sm:py-4 rounded-xl border resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500 text-base sm:text-lg transition-colors ${
        isDark
