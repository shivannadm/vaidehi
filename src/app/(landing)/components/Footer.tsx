    ...
    <footer className="bg-slate-50 border-t border-slate-200 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          {/* Brand Section - ADDED text-center and adjusted social links alignment */}
          <div className="lg:col-span-1 text-center md:text-left">
            <a href="/" className="inline-flex items-center gap-2 mb-4 group">
              <div className="relative w-12 h-12 transition-transform group-hover:scale-110 overflow-hidden rounded-lg">
                <img
          ...
          {/* Link Sections Container (3 columns on mobile, spans 3 columns on lg) */}
        ...
        <div className="mt-12 pt-8 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="/privacy" className="text-sm text-slate-500 hover:text-indigo-600 transition-colors">
              Privacy Policy
            </a>
            <a href="/terms" className="text-sm text-slate-500 hover:text-indigo-600 transition-colors">
              Terms of Service
            </a>
            <a href="/contact" className="text-sm text-slate-500 hover:text-indigo-600 transition-colors">
              Contact
            </a>
          </div>
        </div>
